...
<?php 
   ...
   $selExam = $conn->query("SELECT * FROM examen WHERE num_exam='$exId' ");
...
<div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="row">
                          ...
                          <div class="card-body">
                           <form method="post" id="updateExamFrm">
                              ...
                              <div class="form-group">
                                ...
                                <input type="hidden" name="examId" value="<?php echo $selExamRow['num_exam']; ?>">
                  ...
                  <div class="col-md-6">
                    <?php 
                        $selQuest = $conn->query("SELECT * FROM qcm WHERE exam_id='$exId' ORDER BY num_quest desc");
                    ?>
                     <div class="main-card mb-3 card">
                                          ...
                                          <?php 
                                            ...
                                            if($selQuest->rowCount() > 0)
                                            {
                                               ...
                                               while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr>
                                                        <td >
                                                            <b><?php echo $i++ ; ?> .) <?php echo $selQuestionRow['question']; ?></b><br>
                                                            <?php 
                                                              // Choice A
                                                              if($selQuestionRow['reponse1'] == $selQuestionRow['exam_answer'])
                                                              { ?>
                                                                <span class="pl-4 text-success">A - <?php echo  $selQuestionRow['reponse1']; ?></span><br>
                                                              <?php }
                                                              else
                                                              { ?>
                                                                <span class="pl-4">A - <?php echo $selQuestionRow['reponse1']; ?></span><br>
                                                              <?php }

                                                              // Choice B
                                                              if($selQuestionRow['reponse2'] == $selQuestionRow['exam_answer'])
                                                              { ?>
                                                                <span class="pl-4 text-success">B - <?php echo $selQuestionRow['reponse2']; ?></span><br>
                                                              <?php }
                                                              else
                                                              { ?>
                                                                <span class="pl-4">B - <?php echo $selQuestionRow['reponse2']; ?></span><br>
                                                              <?php }

                                                              // Choice C
                                                              if($selQuestionRow['reponse3'] == $selQuestionRow['exam_answer'])
                                                              { ?>
                                                                <span class="pl-4 text-success">C - <?php echo $selQuestionRow['reponse3']; ?></span><br>
                                                              <?php }
                                                              else
                                                              { ?>
                                                                <span class="pl-4">C - <?php echo $selQuestionRow['reponse3']; ?></span><br>
                                                              <?php }

                                                              // Choice D
                                                              if($selQuestionRow['reponse4'] == $selQuestionRow['exam_answer'])
                                                              { ?>
                                                                <span class="pl-4 text-success">D - <?php echo $selQuestionRow['reponse4']; ?></span><br>
                                                              <?php }
                                                              else
                                                              { ?>
                                                                <span class="pl-4">D - <?php echo $selQuestionRow['reponse4']; ?></span><br>
                                                              <?php }
                                                        ...
                                                        <td class="text-center">
                                                         <a rel="facebox" href="facebox_modal/updateQuestion.php?id=<?php echo $selQuestionRow['num_quest']; ?>" class="btn btn-sm btn-primary">Update</a>
                                                         <button type="button" id="deleteQuestion" data-id='<?php echo $selQuestionRow['num_quest']; ?>'  class="btn btn-danger btn-sm">Delete</button>
                                                        </td>
                                                    </tr>
                                               <?php }
                                            }
