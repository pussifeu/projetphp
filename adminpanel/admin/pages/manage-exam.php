                                    ...
                                    while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                             <a href="manage-exam.php?id=<?php echo $selExamRow['num_exam']; ?>" type="button" class="btn btn-primary btn-sm">Manage</a>
                                             <button type="button" id="deleteExam" data-id='<?php echo $selExamRow['num_exam']; ?>'  class="btn btn-danger btn-sm">Delete</button>
                                            </td>
                                        </tr>
