...
$selCourse = $conn->query("SELECT * FROM examen WHERE ex_title='$examTitle' ");
...
if ($courseSelected == "0") {
    ...
    $insExam = $conn->query("INSERT INTO examen(cou_id,ex_title,ex_time_limit,ex_questlimit_display,ex_description) VALUES('$courseSelected','$examTitle','$timeLimit','$examQuestDipLimit','$examDesc') ");
    if ($insExam) {
