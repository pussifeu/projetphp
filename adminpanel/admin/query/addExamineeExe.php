...
{
	$insData = $conn->query("INSERT INTO etudiant(num_etudiant,exmne_fullname,exmne_course,exmne_gender,exmne_birthdate,niveau,adr_email,exmne_password) VALUES('$number','$fullname','$course','$gender','$bdate','$year_level','$email','$password')  ");
	if($insData)
	{
