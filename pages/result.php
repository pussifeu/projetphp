 <?php 
    $examId = $_GET['id'];
    $selExam = $conn->query("SELECT * FROM examen WHERE num_exam='$examId' ")->fetch(PDO::FETCH_ASSOC);
    ...
    <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    <?php 
                    	...
                    	while ($selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                    		<tr>
                    			<td>
                    				<b><p><?php echo $i++; ?> .) <?php echo $selQuestRow['question']; ?></p></b>
        ...
        <div class="col-md-6 float-left">
        	...
        	<div class="card mb-3 widget-content bg-night-fade">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
                        <div class="widget-heading"><h5>Note</h5></div>
            ...
            <div class="card mb-3 widget-content bg-happy-green">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
                        <div class="widget-heading"><h5>Pourcentage</h5></div>
                        <div class="widget-subheading" style="color: transparent;">/</div>
                        </div>
                        <div class="widget-content-right">
                        <div class="widget-numbers text-white">
